...
It is primarily intended for unsupervised learning using low-level vision. Below you will see some examples of how to use gvnn to do unsupervised learning. We plan to make this a comprehensive and complete library to bridge the gap between geometry and deeplearning. 
